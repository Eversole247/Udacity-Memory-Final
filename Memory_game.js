...
// this function creates a deck of cards that returns an object of cards 
// to the caller
function createDeck() {
...
// used to remove something an array by index
...
app.controller("CardController", function($scope, $timeout) {
    ...
    // start the timer as soon as the player presses the start button
